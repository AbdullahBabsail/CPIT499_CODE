...
public class BannedFragment extends Fragment {
    ...
    private Account_Adpter_BannedPage accountAdpterr;
    private static List<User> userList;
    private  static String Admin_users_page ="http://10.0.2.2/mysql/Admin_User_Show1.php";
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View root=inflater.inflate(R.layout.fragment_banned, container, false);
        recyclerView= root.findViewById(R.id.recycView2);
    ...
    private void LoadAllAnnouncement() {
        JsonArrayRequest request =new JsonArrayRequest(Admin_users_page, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                accountAdpterr = new Account_Adpter_BannedPage(getContext(),userList);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(BannedFragment.this.getContext(), error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        }){
